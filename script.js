...
(function(){
  ...
  function init(){ renderChildSelects(); $('#recChild').value=activeChildId(); loadData(); loadVoicesIntoState(); renderRecords(); if(auth){ auth.onAuthStateChanged(function(){ renderRecords(); }); } }
